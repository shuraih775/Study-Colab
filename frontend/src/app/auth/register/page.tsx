...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-400 to-emerald-400 text-white flex items-center justify-center px-4">
      <div className="w-full max-w-5xl grid md:grid-cols-2 bg-gray-200 rounded-2xl overflow-hidden shadow-2xl border border-stone-600">
        
        {/* Left Section - Register Form */}
        <div className="p-10 flex flex-col justify-center">
          <h2 className="text-3xl font-bold text-stone-800 text-center mb-8 tracking-wide">Register</h2>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="flex gap-4">
              <input
                ...
                className="w-1/2 px-4 py-2  border border-stone-700 text-stone-800  rounded-md placeholder-stone-500 focus:ring-2 focus:ring-amber-500 outline-none"
                required
              />
              <input
                type="text"
        ...
        <div className="bg-gradient-to-br from-emerald-300 to-emerald-600 flex flex-col items-center justify-center p-10 text-center">
          ...
          <p className="text-stone-200 mb-6">Start your journey with the largest<br />community of innovators</p>
          <a href="/auth/login" className="border border-white px-6 py-2 rounded-full text-stone-200 hover:bg-emerald-600 hover:text-white transition">
            Login
          </a>
        </div>
      </div>
